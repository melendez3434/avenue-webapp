  ...
  >
    ...
    <section class="mx-8 mt-12">
      <div>
        ...
        <p class="text-base">
          In order to perform on The Avenue’s events you must have a performer account in The
          Avenue.
        </p>
      </div>
      <div class="mt-8">
        <h3 class="text-xl mb-3">General Rules</h3>
        ...
        <p class="text-base mb-2">
          ...
          if this performance is part of that event or not and if you are going to cook your dish of
          the week or not. If you are going to cook the dish of the week you should also indicate it
          in the title of your performance.
        </p>
        <p class="text-base mb-2">
          Each week of the competition, the event will start on Monday at 12 am EST and End 11:59 pm
          EST Friday. All the vote totals for each competitor will be displayed on the site for all
          to see on the event’s page.
        </p>
      </div>
      <div class="mt-8">
        ...
        <p class="text-base mb-2">
          ...
          place at any time the week before the event’s starting week. Attendees will receive 200
          Avenue Votes (not tip jar votes) to spend on your performance. These points will be added
          at the end of the competition to the total number of votes to help determine the Champion.
          Notice that these points count for the final but they don’t represent money.
        </p>
      </div>
      <div class="mt-8">
        <h3 class="text-xl mb-3">Charity Mondays</h3>
        <p class="text-base mb-2">
          Charity day is always Mondays. The earned money from that day will go to the charity you
          chose for that specific week, but you will still get the points for that performance. The
          performer will be responsible to deliver funds to the charity after they are paid. You
          will want to have the charity promote your competition to support you and gain as many
          votes as you can.
        </p>
      </div>
      <div class="mt-8">
        <h3 class="text-xl mb-3">How to Win</h3>
        <p class="text-base mb-2">
          The top 4 competitors of each week by Friday, as indicated by the competition board, will
          compete on Saturday from 12 pm EST to 12 am EST at the time of your choice. If there is a
          tie all that have the top 4 amount of votes will participate in the FACE-OFF. You can
          stream that week’s competition dish as many times as you wish and indicate that on the
          performance title, but you must cook it on the FACE-OFF too if you qualify. You can stream
          other supporting content to accrue as many votes as you can. On Sunday we will announce
          the winner of that round and they will be declared that round winner for their stated dish
          and receive the progressive total for that round (5 percent of all the votes). In the
          event of a tie, the round will be split amongst the winners. There will be 4 FACE OFF
          challenges and a winner of winners if there is a tie for each round. The FACE-OFF totals
          will not be added to the competition totals.
        </p>
      </div>
      <div class="mt-8">
        <h3 class="text-xl mb-3">Prizes</h3>
        <p class="text-base mb-2">
          As in every other performance in The Avenue, you will get 85% of your tips.
        </p>
        <p class="text-base mb-2">
        ...
        <p class="text-base mb-2">
          The final winner gets 5% of the tips of the entire competition.
        </p>
        <p class="text-base mb-2">
          The organizer gets 5% of the tips of the entire competition.
        </p>
        <p class="text-base mb-2">
          The Avenue gets 15% of the total earnings.
        </p>
      </div>
    </section>
    <div class="container mx-auto text-center mt-20 text-avenue-white-light">
