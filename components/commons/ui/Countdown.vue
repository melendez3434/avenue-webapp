<template>
  ...
  >
    <div class="flex flex-col justify-center items-center w-1/4">
      <span class="font-league-gothic text-5xl md:text-xxl">{{ displayDays }}</span>
      <span class="text-xxs md:text-xl">Days</span>
    </div>
    <div class="flex flex-col justify-center items-center w-1/4">
      <span class="font-league-gothic text-5xl md:text-xxl">{{ displayHours }}</span>
      <span class="text-xxs md:text-xl">Hours</span>
    </div>
    <div class="flex flex-col justify-center items-center w-1/4">
      <span class="font-league-gothic text-5xl md:text-xxl">{{ displayMinutes }}</span>
      <span class="text-xxs md:text-xl">Minutes</span>
    </div>
    <div class="flex flex-col justify-center items-center w-1/4">
      <span class="font-league-gothic text-5xl md:text-xxl">{{ displaySeconds }}</span>
